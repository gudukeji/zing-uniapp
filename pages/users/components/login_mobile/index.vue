	...
	<view v-if="isUp">
		...
		<view class="mobile-mask animated" :class="{slideInUp:isUp}">
			<view class="input-item">
				<input class="input-field" type="text" v-model="account" :placeholder="$t(`输入手机号`)" maxlength="11" />
			</view>
			<view class="input-item">
				<input class="input-field" type="text" v-model="codeNum" :placeholder="$t(`输入验证码`)" maxlength="6" />
				<button :class="['code', { disabled: disabled }]" :disabled="disabled" @click="code">{{text}}</button>
			</view>
